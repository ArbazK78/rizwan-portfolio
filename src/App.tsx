...
const PROJECTS: Project[] = [
  {
    featured: true,
    type: "Featured · Enterprise · Full Stack",
  ...
  },
  {
    featured: false,
    icon: "🏥",
    type: "Healthcare · Full Stack",
    title: "WellCare",
    subtitle: "Real Human Medical Assistance",
    ...
    github: "https://github.com/ArbazK78/WellCare",
  },
  {
    featured: false,
    icon: "🧠",
    type: "AI · Machine Learning",
    title: "AI Demographic Predictor",
    subtitle: "Region, Age & Ethnicity Detection",
...
export default function App() {
  ...
  const navLink = (id: string): React.CSSProperties => ({
    ...
    userSelect: "none",
    borderBottom:
      activeSection === id ? `1.5px solid ${C.p2}` : "1.5px solid transparent",
    transition: "color 0.2s",
  });

  const CONTACT_ITEMS: ContactItem[] = [
    {
      icon: <Mail size={18} color={C.p2} />,
      label: "Email",
      val: "arbazgad@gmail.com",
      href: "mailto:arbazgad@gmail.com",
    },
    {
      icon: <Linkedin size={18} color="#0a66c2" />,
      label: "LinkedIn",
      val: "in/rizwan-gad",
      href: "https://in.linkedin.com/in/rizwan-gad",
    },
    {
      icon: <Github size={18} color={C.sub} />,
      label: "GitHub",
      val: "github.com/ArbazK78",
      href: "https://github.com/ArbazK78",
    },
    {
      icon: <MapPin size={18} color="#ef4444" />,
      label: "Availability",
      val: "Open to Remote Worldwide",
      href: null,
    },
  ];
  ...
  return (
    <>
          ...
          <>
            ...
            <div
              style={{
                ...
                border: `1.5px solid ${hovering ? "#06b6d4" : "rgba(6,182,212,0.6)"}`,
                borderRadius: "50%",
                pointerEvents: "none",
                zIndex: 9998,
                left: ringPos.x,
            ...
            {!isTablet && (
              <button
                ...
                style={{
                  padding: "9px 22px",
                  borderRadius: 8,
                  background: `linear-gradient(135deg,${C.p1},${C.p3})`,
                  color: "#fff",
                  fontSize: 13,
                  fontWeight: 600,
                  border: "none",
            ...
            <Reveal direction="up" delay={100}>
              <div>
                ...
                >
                  <span
                    style={{
                      background: `linear-gradient(135deg,#fff 0%,${C.p3} 55%,${C.p2} 100%)`,
                      WebkitBackgroundClip: "text",
                      WebkitTextFillColor: "transparent",
                    }}
                  >
                ...
                >
                  Full Stack Engineer ·{" "}
                  <span style={{ color: C.p2, fontWeight: 600 }}>
                    Scalable Systems & AI
                  </span>
                </p>
                <p
                ...
                >
                  Specialising in high-performance, scalable architectures with
                  expertise in Java, Spring Boot, Python and AI. Building robust
                  backends that handle high-load data with precision.
                </p>
                <div
                  style={{
                    display: "flex",
                ...
                <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                  {[
                    {
                      label: "GitHub",
                      url: "https://github.com/ArbazK78",
                      icon: <Github size={14} />,
                    },
                    {
                      label: "LinkedIn",
                      url: "https://in.linkedin.com/in/rizwan-gad",
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      onClick={() => toast(`Opening ${s.label}...`, "info")}
                      onMouseEnter={() => setHovering(true)}
                      onMouseLeave={() => setHovering(false)}
                      style={{
                        padding: "8px 16px",
                  ...
                  >
                    <div
                      style={{
                        ...
                        inset: -1,
                        borderRadius: 25,
                        background: `linear-gradient(135deg,rgba(124,58,237,0.6),transparent 50%,rgba(6,182,212,0.4))`,
                        WebkitMask:
                    ...
                    >
                      Scalable systems specialist in Java, Spring Boot & Python
                      — bridging robust backend engineering with AI-driven
                      solutions.
                    </div>
                    <div
                      style={{
          ...
          >
            ...
            <div
              style={{
                width: 1,
                height: 36,
                background: `linear-gradient(to bottom,${C.p1},transparent)`,
      ...
      ══════════════════════════════════ */}
        <section
          id="skills"
          style={{ maxWidth: 1200, margin: "0 auto", padding: sectionPad }}
          ref={skillsRef}
        >
          <Reveal direction="up">
        ...
        >
          <Reveal direction="up">
            <div style={{ marginBottom: 48 }}>
              ...
              >
                Real-world systems engineered for scale, performance, and
                impact.
              </p>
            </div>
          </Reveal>
              ...
              >
                <div
                  style={{
                    ...
                    background: "linear-gradient(135deg,#0d0d1e,#181838)",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    position: "relative",
                    ...
                    {[0, 1, 2, 3, 4, 5, 6, 7].map((i) => (
                      <g key={i}>
                        <rect
                          x={120}
                          y={26 + i * 32}
                          width={[180, 260, 140, 320, 200, 150, 280, 100][i]}
                          height={18}
                          rx={5}
              ...
              >
                {CONTACT_ITEMS.map((ci) => (
                  <a
                    ...
                    href={ci.href ?? "#"}
                    target={
                      ci.href && !ci.href.startsWith("mailto")
                        ? "_blank"
                        : "_self"
                    }
                    rel="noreferrer"
        ...
        <Reveal direction="up" delay={100}>
          ...
          >
            <div style={{ fontSize: 12, color: C.muted }}>
              © 2025 Rizwan Gad - I build things for the web.
            </div>
            <div style={{ display: "flex", gap: 10 }}>
              {[
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  onClick={() => toast(`Opening ${l.label}...`, "info")}
                  onMouseEnter={() => setHovering(true)}
                  onMouseLeave={() => setHovering(false)}
                  style={{
                    padding: "7px 14px",
